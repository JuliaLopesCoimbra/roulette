      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-5xl items-center justify-center px-4">
        ...
        >
          ...
          <motion.div {...fade(0.1)} className="mb-6 text-center">
            ...
            <h1 className="text-xl font-semibold text-black">Área do Cliente</h1>
            {/* <h2 className="text-xl font-semibold text-black">Entrar</h2> */}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <motion.div {...fade(0.2)} className="space-y-1.5">
              <label className="text-xs text-black/70">Senha</label>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-black/60 hover:text-black/80 text-xs"
            ...
            <motion.div {...fade(0.25)} className="mt-2 flex items-center justify-between">
              <a href="/pages/client/forgot" className="text-xs text-black/70 hover:text-black/90 underline-offset-2 hover:underline">
                Esqueci minha senha
              </a>
            ...
            <motion.button
              ...
              className="mt-2 w-full rounded-xl bg-[#f66b41] text-black font-medium py-2.75 transition disabled:opacity-60"
            >
              {isSubmitting ? "Entrando..." : "Entrar"}
            </motion.button>

            {/* rodapé pequeno */}
            <motion.p {...fade(0.35)} className="text-center text-xs text-black/60 mt-3">
              Não tem conta?{" "}
              <a
                href="/pages/client/signUpClient"
                className="text-[#f66b41] hover:text-[#fa234a] font-medium"
              >
                Registre-se
              </a>
            </motion.p>
