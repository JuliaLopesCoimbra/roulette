...
export default function Step1Intro({ next }: { next: () => void }) {
  return (
    ...
    >
      <h1 className="text-2xl md:text-3xl font-bold mb-2">Criar Campanha </h1>
      ...
      <input
        className="w-full p-3 mt-1 rounded bg-black/30 border border-white/10 text-white focus:outline-none focus:ring-2 focus:ring-[#fb4667]"
      ...
      <div className="mt-8 flex gap-3">
        <button
          onClick={next}
          className="flex-1 bg-[#fb4667] hover:bg-[#ff3056] py-3 rounded-lg font-semibold"
        >
          Continuar →
        </button>
      </div>
